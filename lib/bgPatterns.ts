...
- drop/min: how fast blood sugar dropped per minute
...
Find cross-run BG patterns in drop/min, minBG, hypo. Min 4 observations per bucket. Include n for every claim.`;
