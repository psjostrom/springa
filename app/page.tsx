    ...
    <div className="h-screen bg-[#0d0a1a] flex flex-col text-white font-sans overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden">
        ...
        <div className={activeTab === "coach" ? "h-full" : "hidden"}>
          <CoachScreen events={enrichedEvents} phaseInfo={phaseInfo} bgModel={bgModel} raceDate={raceDate} lthr={settings?.lthr} maxHr={settings?.maxHr} hrZones={settings?.hrZones ?? EMPTY_HR_ZONES} paceTable={paceTable} currentBG={currentBG} trendSlope={trendSlope} trendArrow={trend} lastUpdate={lastUpdate} readings={readings} runBGContexts={runBGContexts} />
        </div>
