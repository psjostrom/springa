      ...
      <div
        className={`max-w-[85%] rounded-2xl px-4 py-2.5 text-sm leading-relaxed ${
          isUser
            ...
            : "bg-[#1d1828] border border-[#2e293c] text-[#af9ece]"
        }`}
      >
        {isUser ? content : (
          <ReactMarkdown
            ...
            components={{
              ...
              code: ({ children }) => <code className="bg-[#13101c] px-1 py-0.5 rounded text-[#f23b94] text-xs">{children}</code>,
              ...
              a: ({ href, children }) => <a href={href} className="text-[#f23b94] underline" target="_blank" rel="noopener noreferrer">{children}</a>,
