...
export function WorkoutGenerator({
  ...
  const ctx = buildContext(bgModel, planSettings.raceDate, planSettings.raceDist, planSettings.totalWeeks, planSettings.startKm, planSettings.lthr, planSettings.hrZones, planSettings.includeBasePhase ?? false);
  const weekIdx = getWeekIdx(date, ctx.planStartMonday);
  const suggested = weekIdx >= 0 && weekIdx < planSettings.totalWeeks
