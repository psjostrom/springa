  ...
  return (
    <>
      <button
        ...
        className="w-full text-left bg-[#1e1535] rounded-xl border border-[#3d2b5a] p-4 transition-colors active:bg-[#2a1f3d]"
      >
